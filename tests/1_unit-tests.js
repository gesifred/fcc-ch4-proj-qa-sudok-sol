...
suite('Unit Tests', () => {
	...
	test("Invalid puzzle strings fail the solver", function () {
		//changing pulzze to unsolvable - other ..9..5.1.85.4....2432......1...69.83.9.....6.62.71...9.....21945....4.37.4.3..6..
		let puzzle = "21.9...47739.......8.13...5....9..5..5...........84...8..45..3...4.7..91..6...58.";
		let solutionsMap = solver.findMapOfSolutions(puzzle);
		let result = true;
		// to avoid entering recursive solution if the initial puzzle has a clear flaw
